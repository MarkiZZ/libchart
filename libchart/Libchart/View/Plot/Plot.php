...
class Plot
{
    ...
    private function computeGraphArea()
    {
        ...
        $graphArea = null;
        if ($this->hasCaption) {
            $graphUnpaddedRight = $this->imageArea->x1 + ($this->imageArea->x2 - $this->imageArea->x1) - $this->getCaptionWidth();
    ...
    private function getCaptionWidth()
    {
        return $this->captionPadding->left + $this->captionPadding->right + $this->desiredCaptionWidth;
    }
     ...
     * @return \Libchart\View\Primitive\Padding
     */
     ...
     * @param integer caption padding
     */
    public function setDesiredCaptionWidth($captionWidth)
    {
        $this->desiredCaptionWidth = $captionWidth;
    }
